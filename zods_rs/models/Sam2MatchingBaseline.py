...
from zods_rs.models.matching_baseline_utils import SAM2AutomaticMaskGenerator_MatchingBaseline
...
class Sam2MatchingBaseline(nn.Module):
    ...
    def _forward_encoder(self, imgs, normalize=True):
        ...
        feats = self.encoder.tokens_from_images(imgs, normalize=normalize)
        if normalize:
