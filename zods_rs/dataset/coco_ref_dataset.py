...
class COCORefTestDataset(COCORefTrainDataset):
    ...
    def encode_results(self, output_dicts, out_format: str = "mask"):
        results = []
    ...
    def sample_negative(self, results, out_pkl, out_json, sample_num, score_thr=0.0):
        from zods_rs.dataset.data_utils import is_valid_annotation, get_false_positives
