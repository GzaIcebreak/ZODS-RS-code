...
from zods_rs.pl_wrapper.sam2ref_pl import RefSam2LightningModel
from zods_rs.pl_wrapper.sam2matcher_pl import Sam2MatcherLightningModel
        ...
        if (
            ...
            if not dist.is_initialized() or dist.get_rank() == 0:
                ...
                if self.model.test_mode == "test":
                    ...
                    # Evaluating the results - skip for custom datasets to avoid division by zero
                    try:
                        ...
                        print("Check visualization results in results_analysis/ directory")
